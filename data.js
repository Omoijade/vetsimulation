(function (root) {
  ...
  const candidates = [
    ...
    { id: "vet-imaging-partial", name: "Dr Yusuf Aydin", role: "vet", baseSalary: 58000, expectedSalary: 58000, capacity: 900, postingFee: 500, skills: ["general", "ultrasound"], primaryService: "ultrasound", pitch: bi("Imaging skill at reduced hours: cheaper per year, fewer hours to allocate.", "Compétence d’imagerie à horaire réduit : moins cher à l’année, moins d’heures à répartir.") },
    { id: "vet-dentistry-second", name: "Dr Hannah Weiss", role: "vet", baseSalary: 59000, expectedSalary: 59000, capacity: 1500, postingFee: 500, skills: ["general", "dentistry"], primaryService: "dentistry", pitch: bi("Covers dentistry at a lower salary than the established specialist.", "Couvre la dentisterie à un salaire inférieur à celui du spécialiste établi.") },
    { id: "vet-generalist-partial", name: "Dr Marc Lefevre", role: "vet", baseSalary: 38000, expectedSalary: 38000, capacity: 800, postingFee: 500, skills: ["general"], primaryService: "consult", pitch: bi("Half the hours of a full-time vet, for well under half the salary.", "Deux fois moins d’heures qu’un vétérinaire à temps plein, pour bien moins de la moitié du salaire.") },
    { id: "support-surgery-second", name: "Sofia Almeida", role: "support", baseSalary: 33000, expectedSalary: 33000, capacity: 1200, postingFee: 400, skills: ["preventive", "surgery"], primaryService: "surgery", pitch: bi("A second route to surgical support, at reduced hours.", "Une seconde voie vers le soutien chirurgical, à horaire réduit.") },
    { id: "support-diagnostics", name: "Tomas Varga", role: "support", baseSalary: 35000, expectedSalary: 35000, capacity: 1545, postingFee: 400, skills: ["lab", "imaging"], primaryService: "lab", pitch: bi("Covers laboratory and imaging together, full time.", "Couvre le laboratoire et l’imagerie ensemble, à temps plein.") },
    { id: "support-emergency", name: "Nadia Haddad", role: "support", baseSalary: 34000, expectedSalary: 34000, capacity: 1500, postingFee: 400, skills: ["emergency", "inpatient"], primaryService: "emergency", pitch: bi("Covers emergencies and hospitalised animals.", "Couvre les urgences et les animaux hospitalisés.") }
  ];
